...
const navItems = [
  ...
  { label : "My Orders" , path: "/orderhistory", icon: ShoppingBag, tag: "Orders", desc: "View your order history", accent: "#34D399" },
  { label: "Inquiries",  path: "/user/inquiries", icon: Info,          tag: "Inquiries", desc: "View and manage inquiries", accent: "#38BDF8" },
] 
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ul-user-badge {
          ...
          padding: 2px 6px; border-radius: 99px; letter-spacing: 0.07em; flex-shrink: 0; text-transform: uppercase;
        }
